...
router.get("/getMoviesPopular", async function (req, res, next) {
  let url = `https://api.themoviedb.org/3/discover/movie?api_key=f0929bf9c301536f2f4ad539f4689057&language=fr-FR&include_adult=false&with_genres=35,16&sort_by=vote_count.desc&page=1`;
